...
namespace JSG.WordPalace
{
    ...
    public class UIMessage_A : MonoBehaviour
    {
        ...
        void Start()
        {
            switch (m_MessageType)
            {
                case 0:
                    ...
                    m_ButtonPanels[4].gameObject.SetActive(false);
                    m_ButtonPanels[5].gameObject.SetActive(false);
                    break;
                case 1:
                ...
                case 4:
                    ...
                    m_ButtonPanels[2].gameObject.SetActive(false);
                    m_ButtonPanels[3].gameObject.SetActive(false);
                    m_ButtonPanels[4].gameObject.SetActive(true);
                    m_ButtonPanels[5].gameObject.SetActive(false);
                    break;
                case 5:
                    m_ButtonPanels[0].gameObject.SetActive(false);
                    ...
                    m_ButtonPanels[3].gameObject.SetActive(false);
                    m_ButtonPanels[4].gameObject.SetActive(false);
                    m_ButtonPanels[5].gameObject.SetActive(true);
                    break;
            }
        ...
        public void AutoCloseMessage(float time)
        {
